...
> 💡 *Because this is a single HTML file, simply open index.html in any modern browser (Chrome, Edge, Firefox). No server required.*
...
- Set FPS (6–60) and press ▶️ to play
...
PixieR-Studio/
├── index.html ← Complete application (CSS + JS + HTML)
├── icon.png ← For Web Icon
├── dev-check ← To check if user a pc/laptop user, if it is not than redirect otomaticaly
└── README.md ← This file


> All code is contained in one HTML file for easy distribution.
